	...
	<div class="displayTable">
		<display:table id="data" name="listaCategorias" requestURI="/abmCategoria_search.do" pagesize="5" export="true" class="table table-striped table-condensed" excludedParams="*">
